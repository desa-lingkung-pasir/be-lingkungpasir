...
<head>
  ...
  <!-- FAVICON -->
  <link href="images/lingkungpasir.png" rel="shortcut icon" />
              ...
              <div class="col-lg-6 col-md-10">
                <div class="card card-default mb-0">
                  <div class="card-header pb-0">
                    <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                      <a class="w-auto pl-0" href="#">
                        <img src="images/lingkungpasir.png" alt="Lingkungpasir">
                        <span class="brand-name text-dark">Desa Lingkungpasir</span>
                      </a>
                    </div>
                  </div>
                  <div class="card-body px-5 pb-5 pt-0">
                    ...
                    <form action="{{ url('/check-login') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                      <div class="row">
